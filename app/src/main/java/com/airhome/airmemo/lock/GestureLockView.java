...
public class GestureLockView extends View {
    private boolean isFirstSetLock = true;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isInit) {
            initView();
            isSetLock = Preferences.isSetLock(getContext());
            if (isSetLock) {
